<template>
  ...
  <div v-for="item in withdrawHistories.data" :key="item.id" class="trans-item">
    ...
    <div class="trans-info">
      ...
      <label class="trans-des">
        ...
        <p>
          <span :style="{ color: item.status == '3' ? '#2dd36f' : '#ec1a23' }" class="trans-status">
            {{ item.status_text }}
          </span>
        </p>
  ...
  <div class="flex justify-center mt-2">
    <v-btn type="link" class="text-none" v-if="withdrawHistories.data?.length < withdrawHistories?.total"
