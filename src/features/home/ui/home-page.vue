<template>
  <main class="main">
    <div class="mv">
      <v-carousel class="<md:hidden" :show-arrows="false" :interval="3000" hide-delimiters height="calc(500/1920*100vw)" cycle>
        <v-carousel-item v-for="(banner, i) in banners.pc" :key="i" :src="banner.url" cover />
      </v-carousel>
      <v-carousel class="md:hidden" :show-arrows="false" :interval="3000" hide-delimiters height="calc(280/750*100vw)" cycle>
